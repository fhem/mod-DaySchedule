...
* Master branch: Production version (copy of [fhem/fhem-mirror/blob/master/fhem/FHEM/95_DaySchedule.pm](https://github.com/fhem/fhem-mirror/blob/master/fhem/FHEM/95_DaySchedule.pm))
...
Identified bugs and feature requests are tracked using [Github Issues](https://github.com/fhem/DaySchedule/issues).
